...
* know when to use I' charts as alternatives to traditional SPC charts, and

* be able to construct I' charts using R.

::: aside
https://github.com/anhoej/pbc_webinar
:::
...
::: aside
n = numerators, d = denominators, o = number of subgroups, i = i^th^ data value
:::
